"""
IMPROVED BOOKING SLOT GENERATION COMMAND

Purpose: Generate booking slots for services based on provider availability schedules
This command creates time slots for services according to provider availability,
categorizing them appropriately based on time and day.
...
Features:
- Generates slots based on provider availability schedules
- Proper slot categorization (normal, express, urgent, emergency)
- Service and provider-specific generation capabilities
...
class Command(BaseCommand):
    help = 'Generate booking slots for services based on provider availability'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"🕐 Starting slot generation process ({timezone.now()})")
    ...
    def _categorize_slot_by_requirements(self, date, start_time):
        ...
        # Weekdays (Mon-Fri)
            ...
            # Urgent Express Slots: Late Night (22:00 – 23:00)
                ...
                return {'category': 'urgent', 'is_express_only': False}
